...
export const trustPages: Record<TrustPageId, TrustPageContent> = {
    about: {
        ...
        lead: "Мы строим headless интернет-магазин дверей, где покупатель видит реальные товары из WooCommerce, выбирает комплектацию и отправляет заказ менеджеру без онлайн-оплаты.",
        facts: [
            ...
            { label: "Фокус MVP", value: "Межкомнатные двери и фурнитура" },
        ],
        sections: [
            {
                id: "what-we-do",
            ...
            {
                id: "mvp-principles",
                title: "Как устроен заказ на MVP",
                description: "На старте мы не подключаем онлайн-оплату и не заставляем клиента проходить регистрацию.",
                items: [
    ...
    contacts: {
        ...
        lead: "На MVP заказ оформляется без онлайн-оплаты: после отправки корзины менеджер связывается с вами, проверяет состав заказа и уточняет условия доставки и установки.",
        facts: [
    ...
    payment: {
        ...
        description: "На MVP онлайн-оплаты нет: заказ сначала проверяет менеджер, затем согласуются финальные условия.",
        metaTitle: "Оплата заказа",
        metaDescription: "Оплата дверей без онлайн-оплаты на MVP: заказ создаётся в WooCommerce, условия подтверждает менеджер.",
        lead: "Такой сценарий безопаснее для старта: цена двери берётся из WooCommerce, а доставка, установка и нестандартные условия согласуются отдельно.",
        facts: [
            { label: "Онлайн-оплата", value: "Не подключена на MVP" },
    ...
    installation: {
        ...
        lead: "Для MVP установка не смешивается с товарной ценой двери. Это отдельный сервисный слой, который менеджер уточняет после оформления заказа.",
        facts: [
            { label: "Статус услуги", value: "Ручное согласование" },
            { label: "Что важно", value: "Проём, коробка, стены, пол" },
            { label: "Будущий слой", value: "Order service" },
        ],
        sections: [
            {
            ...
            },
            {
                ...
                items: [
                    ...
                    "Автоматический расчёт появится позже как отдельный слой заказа.",
                ],
            },
        ],
        primaryCta: { label: "Выбрать дверь", href: "/mezhkomnatnye-dveri" },
