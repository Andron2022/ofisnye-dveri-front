...
export async function getWallPanelsPageContent(): Promise<WallPanelsPageContent> {
    try {
        ...
        return {
            ...
            introEyebrow: getAcfString(acf, "wall_panels_intro_eyebrow"),
            introTitle: getAcfString(acf, "wall_panels_intro_title"),
            ...
            productsEyebrow: getAcfString(acf, "wall_panels_products_eyebrow"),
            ...
            ctaTitle: getAcfString(acf, "wall_panels_cta_title"),
